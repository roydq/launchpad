...
> **Status: Not Started** — branch `feat/e2e-testing`
...
- [ ] **Step 1: Create package docs with build tag**
...
- [ ] **Step 4: Confirm default tests exclude e2e**
...
- [ ] **Step 1: Write `scripts/e2e-stub.sh`**
...
- [ ] **Step 2: Write `scripts/e2e-kind.sh`**
...
- [ ] **Step 4: Run kind e2e** (when Docker/kind available)
...
- [ ] **Step 1: PR CI with unit + stub e2e**
...
- [ ] **Step 3: Mark design status Approved / plan Completed when PR-ready**
...
- [ ] `go test ./...` still excludes e2e package
