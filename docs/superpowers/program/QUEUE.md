...
|-----|-----|------|-------|--------|--------------|-------------|
| 1 | secrets-design | Secrets-typed config (**design only**) | D | pr-open | Spec: `docs/superpowers/specs/2026-07-18-secrets-typed-config-design.md` — **hard stop before S1 code** until human accepts model | `feat/secrets-design` · [#26](https://github.com/roydq/launchpad/pull/26) |
