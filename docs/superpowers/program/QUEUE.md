...
|-----|-----|------|-------|--------|--------------|-------------|
| 1 | secrets-s2 | Secrets S2: AES-GCM at rest | D | implementing | Spec § S2: `LAUNCHPAD_SECRETS_KEY`; encrypt secret rows + release snapshot; worker decrypt. | `feat/secrets-s2` |
