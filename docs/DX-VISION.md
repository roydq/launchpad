...
| Work | Spec / queue |
|------|----------------|
| **Next** | QUEUE `preview-process-fold` (implementing, `feat/preview-process-fold`) — [spec](superpowers/specs/2026-09-13-preview-process-fold-design.md); then surfaces (docs site → TUI → dashboard) |
